                        ...
                        <section class="slideshow">
                            <div class="content">
                                <div class="slider-content">
                                    <figure v-for="item in images" class="shadow">
                                        <img :src="item">
                                    </figure>
...
// const images = ref<string[]>(['https://tool.botup.io/media/doan_thanh_nien/oyb3P3eTKP1697208023787_24161842546762570.png'])
const images = ref<string[]>([
    ...
    'https://tool.botup.io/media/doan_thanh_nien/2hsi8FQudX1697203348615_5680936092005108.png',
    ...
    fetch(`https://tool.botup.io/v1/hoi_truong_dai_hoi`, {})
        ...
        .then(r => {
            ...
            files = files.map((item: string) => {
                item = `https://tool.botup.io/media/hoi_truong_dai_hoi/${item}`
                return item
            })
